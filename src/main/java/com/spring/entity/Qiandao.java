...
public class Qiandao implements Serializable {
    ...
    @Column(name = "qiandaoren")
    private String qiandaoren;
    private Integer keqiankaoqinid;
    ...
    public void setQiandaoshijian(String qiandaoshijian) {
        this.qiandaoshijian = qiandaoshijian == null ? "" : qiandaoshijian.trim();
    }

    public String getQiandaoren() {
        return qiandaoren;
    }
    public void setQiandaoren(String qiandaoren) {
        this.qiandaoren = qiandaoren == null ? "" : qiandaoren.trim();
    }
    public Integer getKeqiankaoqinid() {
        return keqiankaoqinid;
    }
    public void setKeqiankaoqinid(Integer keqiankaoqinid) {
        this.keqiankaoqinid = keqiankaoqinid == null ? 0 : keqiankaoqinid;
    }
